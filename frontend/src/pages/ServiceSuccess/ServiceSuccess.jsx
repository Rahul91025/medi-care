            ...
            <div className="relative w-full max-w-md bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/50 border border-slate-100 text-center">
                {status === "verifying" && (
                    <div className="flex flex-col items-center animate-pulse">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 mb-2">Verifying Service Payment</h2>
                        <p className="text-slate-500 font-medium">Please wait while we confirm your service booking with the payment provider...</p>
                    </div>
                )}
                ...
                {status === "success" && (
                    <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
                        ...
                        <p className="text-slate-500 font-medium mb-8 leading-relaxed">
                            Your service appointment has been perfectly booked and confirmed. A receipt has been sent to your email.
                        </p>
                        <Link
                            to="/appointments"
